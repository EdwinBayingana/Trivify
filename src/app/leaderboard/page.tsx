    ...
    <Container>
      ...
      <Section className="flex flex-row gap-[30px] justify-center items-center">
        <div>
          ...
          />
          <Text className="text-black text-[18px] text-center py-2">Jane</Text>
        </div>
        ...
        <div>
          ...
          />
          <Text className="text-black text-[18px] text-center py-2">Smith</Text>
        </div>
        ...
        <div>
          <Image
            ...
            className="text-gray-600 mt-5 w-[150px] h-[150px] rounded-full object-cover"
          />
          <Text className="text-black text-[18px] text-center py-2">Doe</Text>
        </div>
      </Section>
    </Container>
  );
